...
var previewTemplate = "<div class=\"dz-preview dz-file-preview\">\n " +
    " <div class=\"dz-image\"><img class='img-fluid' data-dz-thumbnail/></div>\n  " +
...
$(function () {
        ...
        function (i, obj) {
            ...
            drop.on("success", function (file, response) {
                if ($(obj).hasClass('multi')) {
                    ...
                    if (response && response.link) {
                        this.emit('thumbnail', file, /*"/assets/"+*/ response.link );
                        f.val(response.link);
            ...
            if (f.val()) {
                ...
                drop.options.thumbnail.call(drop, mockFile, /*"/assets/" +*/mockFile.url );
                drop.files = [mockFile];
    ...
    $('div.dropzone.pdfFile').each(  function (i, obj) {  loadFileUploader(i, obj, '/api/Uploader/UploadPDFFile/', acceptedPDFFiles)});
    $('div.dropzone.pngFile').each(  function (i, obj) {  loadFileUploader(i, obj, '/api/Uploader/UploadPNGFile/', acceptedPNGFiles)});

    $('div.dropzone.videoFile').each(
        function (i, obj) {
